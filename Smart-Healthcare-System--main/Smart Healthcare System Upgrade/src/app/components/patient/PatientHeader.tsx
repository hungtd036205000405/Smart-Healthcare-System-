...
const navItems = [
  ...
  { path: '/patient/search', label: 'Tìm bác sĩ' },
  { path: '/patient/booking', label: 'Đặt lịch khám' },
  { path: '/patient/online-consult', label: 'Khám online' },
  { path: '/patient/payment', label: 'Thanh toán' },
  { path: '/patient/records', label: 'Hồ sơ y tế' },
  { path: '/patient/history', label: 'Lịch sử khám' },
  { path: '/patient/health-tracking', label: 'Theo dõi sức khỏe' },
];
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 pl-2 border-l border-gray-200">
              ...
              <div className="hidden sm:block">
                <p className="text-sm font-semibold text-gray-900 leading-tight">Nguyễn Văn A</p>
