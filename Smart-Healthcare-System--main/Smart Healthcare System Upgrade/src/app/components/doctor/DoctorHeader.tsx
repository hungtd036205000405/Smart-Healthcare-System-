        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/doctor/home" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <div>
              ...
              <p className="text-xs text-blue-600 font-medium -mt-0.5">Doctor Portal</p>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-3">
                        ...
                        {notifications.map((notif) => (
                          ...
                          >
                            <div className="flex items-start gap-2">
                              {notif.unread && (
                                <span className="size-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                              )}
            ...
            <div className="flex items-center gap-2 pl-2 border-l border-gray-200">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-blue-600 font-medium -mt-0.5">Tim mạch</p>
              </div>
